...
#include "DDEquipClothWatch.generated.h"

UCLASS()
class THEDOLDRUMS_API ADDEquipClothWatch : public AActor
{
	GENERATED_BODY()
...
public:
	...
	TObjectPtr<class USkeletalMeshComponent> Watch;

	UPROPERTY(VisibleAnywhere, BlueprintReadWrite, Category = Box)
	TObjectPtr<class UBoxComponent> TriggerWatch;
