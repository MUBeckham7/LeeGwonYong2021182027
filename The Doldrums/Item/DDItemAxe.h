...
#include "DDItemAxe.generated.h"

UCLASS()
class THEDOLDRUMS_API ADDItemAxe : public AActor
{
	GENERATED_BODY()
...
public:	
	...
	TObjectPtr<class UStaticMeshComponent> Axe;

	UPROPERTY(VisibleAnywhere, BlueprintReadWrite, Category = Box)
	TObjectPtr<class UBoxComponent> TriggerAxe;
	...
	UPROPERTY(EditAnywhere, Category = Item)
	TSubclassOf<class UNarrativeItem> ItemDDAxeClass;
