...
objRead objReader;
GLint Object = objReader.loadObj_normalize_center("12934_Wooden_Chess_Rook_Side_B_V2_L3.obj");
...
void viewTransform() {
	glm::vec3 cameraPos = glm::vec3(0.0f, 3.0f, 10.0f+move_z); //--- 카메라 위치
...
void ambientlight() {
	...
	glUniform3f(viewPosLocation, 0.0f, 3.0f, 10.0f);
